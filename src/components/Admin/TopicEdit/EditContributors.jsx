// Subcomponent for editing Contributor info

import React, { Component } from 'react';
import { Card, Image, Container, Row, Col, FormLabel, FormControl } from 'react-bootstrap';

// Component for uploading images. Uses FileStack API
...
export default class EditContributors extends Component {
  ...
  render() {
    return (
      ...
      {/* Top Section - Displays Static Info */}
        <Row>
          <Col>
            ...
            <Card>
              <Card.Body>
                ...
                <FormControl onChange={this.props.handleTextChange}
                  ...
                  as="textarea"
                  rows="3" />
                <img src={this.props.editPhoto1} width="100" />
            ...
            <Card>
              <Card.Body>
                ...
                <FormControl onChange={this.props.handleTextChange}
                  ...
                  as="textarea"
                  rows="3" />
                <img src={this.props.editPhoto2} width="100" />
